...
import preciousPortrait from "@/assets/precious-portrait.jpeg";
...
const Hero = () => {
  ...
  return {
    ...
    compliance: "HIPAA-certified"
        ...
        <div
          className='absolute top-1/3 right-20 text-code-overlay font-mono text-sm animate-float'
  ...
  specialization: "healthcare & insurance"
        ...
        <div
          className='absolute bottom-32 left-1/4 text-code-overlay font-mono text-sm animate-float'
  ...
  ensureCompliance();
      ...
      <div className='container mx-auto px-4 md:px-12 min-h-screen flex items-center'>
          ...
          <div className='space-y-8 animate-fade-in-up'>
            <div className='space-y-4'>
              ...
              <p className='text-xl text-muted-foreground leading-relaxed'>
                Compassionate, detail-oriented Customer Service Professional
                with 3+ years' experience in healthcare, insurance, and benefits
                administration. Achieving 95%+ first-contact resolution while
      ...
      {/* Social Links */}
      <div
        className='absolute bottom-8 left-1/2 transform -translate-x-1/2 flex gap-4 animate-fade-in'
        style={{ animationDelay: "1s" }}>
        <a
